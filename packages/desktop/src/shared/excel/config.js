...
exports.DATE_CONFIG = exports.VALIDATION_CONFIG = exports.STYLE_CONFIG = exports.CATEGORIZATION_CONFIG = exports.COLUMN_MAPPING_CONFIG = exports.TAB_DETECTION_CONFIG = exports.TEMPLATE_CONFIG = exports.PARSING_CONFIG = exports.UNIFIED_TEMPLATE_CONFIG = exports.TRAFFIC_SHEET_CONFIG = exports.DEMOGRAPHIC_CONFIG = exports.ROW_EXPANSION_CONFIG = void 0;
...
exports.ROW_EXPANSION_CONFIG = {
    ...
    AD_GROUP_RULES: {
        ...
        PROGRAMMATIC: {
            PLATFORMS: ['Trade Desk', 'TTD', 'Amazon', 'Amazon DSP', 'Prime Video', 'DV360'],
        ...
        META: {
            PLATFORMS: ['Meta', 'Facebook', 'Instagram', 'FB', 'IG'],
            AD_GROUPS: 3,
        },
        // Other social platforms (1 ad group)
        OTHER_SOCIAL: {
            PLATFORMS: ['TikTok', 'Tik Tok', 'Pinterest', 'Pin', 'Snapchat', 'Snap', 'Reddit'],
            AD_GROUPS: 1,
        },
        // Non-programmatic display and audio (4 ad groups)
        DISPLAY_AUDIO: {
            MEDIA_TYPES: ['Display', 'Audio'],
            AD_GROUPS: 4,
        },
    ...
    MERGE_LEVELS: {
        ...
        CAMPAIGN: ['channel', 'platform', 'mediaType', 'objective', 'startDate', 'endDate', 'grossBudget', 'netBudget', 'language'],
        // Ad Group-level fields: span 5 rows each (merged across creative lines)
        AD_GROUP: ['accuticsCampaignName', 'targeting', 'target', 'kpi', 'placements', 'buyType'],
...
exports.UNIFIED_TEMPLATE_CONFIG = {
...
exports.PARSING_CONFIG = {
    ...
    COMMON_HEADERS: ['channel', 'platform', 'objective', 'budget'],
...
exports.CATEGORIZATION_CONFIG = {
    ...
    INFLUENCER_KEYWORDS: ['influencer'],
    // Paid social keywords
    PAID_SOCIAL_KEYWORDS: ['paid social', 'social'],
...
exports.VALIDATION_CONFIG = {
    ...
    REQUIRED_TACTIC_FIELDS: ['channel', 'platform'], // 'mediaType' is optional
